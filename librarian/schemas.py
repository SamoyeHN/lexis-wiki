...
class ExpressionItem:
    design_audit: str = dataclasses.field(default="", metadata={"description": "Thinking Step. Step 1: identify verbatim surface phrase in text. Step 2: formulate canonical base headword with slot placeholders for variable arguments. Step 3: categorize and check uniqueness. Format: 'DRAFT: [Surface Text Excerpt] -> [Canonical Headword with Slots] -> [Category: phrasal verb/collocation/idiom/set phrase] -> [Uniqueness Check]'. Example: 'DRAFT: putting out graphic brochures -> put [something] out -> phrasal verb -> New'.", "minLength": 1})
    word: str = dataclasses.field(default="", metadata={"description": "The standardized canonical headword entry form. It MUST match the [Canonical Headword with Slots] from design_audit, retaining all bracketed argument placeholders (e.g. 'put [something] out', 'lay siege to [entity]', 'take [something] for granted', 'bring about [something]').", "minLength": 1})
