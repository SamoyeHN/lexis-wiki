    ...
    def get_default_template(name):
        ...
        templates = {
            ...
            "extract_expressions": (
                ...
                "   - `quoted_sentence` MUST be the exact verbatim sentence from the source text where the expression appears.\n"
            ...
            "extract_grammar": (
                ...
                "- 🚫 **ABSOLUTE BAN ON REWRITING OR TAMPERING**: NEVER alter, invert, rewrite, or paraphrase sentences from the text to fit a grammatical category (e.g., NEVER manually invert standard sentences). The quote MUST be a 100% exact substring of the passage. Fabricating or rewriting quotes is strictly prohibited. If a structure does not naturally exist verbatim in the text, skip that category!\n\n"
