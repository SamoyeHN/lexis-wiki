    ...
    def get_default_template(name):
        ...
        templates = {
            ...
            "extract_expressions": (
                ...
                "### CORE PEDAGOGICAL MANDATES:\n"
                "1. **Target Count**: Extract up to {count} unique multi-word expressions found in the text. Aim for about {count} if the text contains enough suitable expressions. Never pad the list with single words, duplicates, or non-idiomatic phrases.\n"
                ...
                "4. **Idiomatic & Pedagogical Focus**: Prioritize multi-word expressions with high pedagogical value (phrasal verbs, idioms, fixed collocations) that are crucial for B1–C2 fluency and academic literacy. Do NOT extract single words or literal, transparent word combinations (e.g., choose \"take for granted\" or \"pose a threat to [entity]\" over \"walk to school\").\n"
                "5. **Contextual Accuracy & Original Usage**:\n"
